...
export const tecnicos: Tecnico[] = [
  { id: "t1", nombre: "Marta Hernández", organizacion: "GAL PROYNERSO · Nordeste de Soria" },
];
...
export const empresas: Empresa[] = [
  { id: "e1", nombre: "Cárnicas del Moncayo", municipioId: "m1", cp: "42110", sector: "Agroalimentario", vacantes: 18, esTractora: true },
  { id: "e2", nombre: "Maderas de Ágreda", municipioId: "m2", cp: "42100", sector: "Madera", vacantes: 6, esTractora: false },
  { id: "e3", nombre: "Quesería artesana de Borobia", municipioId: "m3", cp: "42138", sector: "Agroalimentario", vacantes: 4, esTractora: false },
];

export const viviendas: Vivienda[] = [
  { id: "v1", municipioId: "m1", titulo: "Piso reformado centro", tipo: "piso", plazas: 4, precio: 420, estado: "publicada", admiteMascotas: true },
  { id: "v2", municipioId: "m1", titulo: "Casa con patio", tipo: "casa", plazas: 5, precio: 520, estado: "publicada", admiteMascotas: true },
  { id: "v3", municipioId: "m1", titulo: "Estudio plaza Mayor", tipo: "estudio", plazas: 2, precio: 320, estado: "reservada", admiteMascotas: false },
  { id: "v4", municipioId: "m2", titulo: "Casa de pueblo rehabilitada", tipo: "casa", plazas: 5, precio: 450, estado: "publicada", admiteMascotas: true },
  { id: "v5", municipioId: "m2", titulo: "Piso céntrico junto a la plaza", tipo: "piso", plazas: 3, precio: 380, estado: "publicada", admiteMascotas: false },
  { id: "v6", municipioId: "m3", titulo: "Casa con huerto", tipo: "casa", plazas: 4, precio: 300, estado: "publicada", admiteMascotas: true },
  { id: "v7", municipioId: "m3", titulo: "Apartamento reformado", tipo: "piso", plazas: 2, precio: 260, estado: "alquilada", admiteMascotas: false },
];
